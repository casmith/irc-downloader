...
public class IncomingFileTransferListenerTest {
    ...
    public void testGetDownloadFile() {
        ...
        IncomingFileTransferListener incomingFileTransferListener = new IncomingFileTransferListener(null, new Configuration("/downloads"), null, new NoopProducer(), dao, null);
